...
const Sidebar = () => {
  ...
  const renderedSidebarIcon = showSidebar ? (
    <ImCancelCircle />
  ) : (
    <AiOutlineMenu />
  );

  const renderedUserProfile = !userProfile && (
  ...
  const renderedSidebar = showSidebar && (
  ...
  const sidebarOnClick = () => setShowSidebar(prev => !prev);
